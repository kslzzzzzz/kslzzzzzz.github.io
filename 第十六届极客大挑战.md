...
?>
```
#### 对长度有限制 可从 /etc/issue或其它路径 得到为linux系统 注：php://fd/[0-9]+ 会被长度限制 遍历/dev/fd/[0-9]+ 在http://019aa0d2-a4d8-7aad-be91-06a2d3f5a783.geek.ctfplus.cn/aa__%5E%5E.php?filename=/dev/fd/13 #### 找到SYC{019aa0d2a4c279258ab0ec221edfe943}
## Crypto题
### 第一题 baby_rabin
